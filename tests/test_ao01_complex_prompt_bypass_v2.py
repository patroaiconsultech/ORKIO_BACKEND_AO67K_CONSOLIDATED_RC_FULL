...
def test_saas_prompt_reaches_full_runtime() -> None:
    _assert_full_runtime(PROMPT_SAAS)


def test_scenario_prompt_reaches_full_runtime() -> None:
    _assert_full_runtime(PROMPT_SCENARIOS)


def test_council_prompt_reaches_full_runtime() -> None:
    _assert_full_runtime(PROMPT_COUNCIL)


def test_simple_executive_prompt_keeps_fast_template() -> None:

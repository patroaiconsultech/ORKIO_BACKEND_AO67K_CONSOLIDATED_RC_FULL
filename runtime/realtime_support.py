...
class RealtimeClientSecretReq(BaseModel):
    ...
    manual_target_slug: Optional[str] = Field(default=None, description="Manual UI authority slug.")
    target_agent_slugs: Optional[Any] = Field(default=None, description="Canonical requested agent slug list.")
    multi_agent_turn: Optional[bool] = Field(default=None, description="Whether the turn should materialize multiple agents.")
    response_control: Optional[str] = Field(default=None, description="Response control contract.")
    manual_agent_lock: Optional[bool] = Field(default=None, description="Manual UI authority lock.")
    manual_agent_source: Optional[str] = Field(default=None, description="Manual authority source.")
    manual_authority_version: Optional[str] = Field(default=None, description="Manual authority contract version.")
    manual_sticky_state_version: Optional[str] = Field(default=None, description="Manual sticky-state contract version.")
    manual_lock_persistence_version: Optional[str] = Field(default=None, description="Manual lock persistence contract version.")
    manual_lock_staging_proof_version: Optional[str] = Field(default=None, description="Manual lock staging proof version.")
    manual_lock_staging_proof_production_guard_version: Optional[str] = Field(default=None, description="Manual lock staging proof production guard version.")
    auto_handoff_enabled: Optional[bool] = Field(default=None, description="Whether auto handoff may override manual authority.")
    manual_team_panel_required: Optional[bool] = Field(default=None, description="Team panel required flag.")
    manual_team_panel_order: Optional[Any] = Field(default=None, description="Team panel order.")
    team_panel_version: Optional[str] = Field(default=None, description="Team panel version.")
    team_panel_mode: Optional[str] = Field(default=None, description="Team panel mode.")
    team_panel_voice_moderator_slug: Optional[str] = Field(default=None, description="Team panel voice moderator.")
    manual_team_conversation_active: Optional[bool] = Field(default=None, description="PATCH_33 Team conversation room is active.")
    manual_team_focus_slug: Optional[str] = Field(default=None, description="PATCH_33 promoted/focused Team participant.")
    manual_team_turn_queue: Optional[Any] = Field(default=None, description="PATCH_33 Team turn queue.")
    manual_team_turn_index: Optional[int] = Field(default=None, description="PATCH_33 Team turn index.")

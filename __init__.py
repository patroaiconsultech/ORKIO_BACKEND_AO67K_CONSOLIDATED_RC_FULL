"""ORKIO runtime public API.

Preserves the historical runtime facade used by app.main while allowing
premium runtime configuration modules to coexist as direct submodules.
"""
